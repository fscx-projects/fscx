...
#r @"packages/FAKE.4.61.3/tools/FakeLib.dll"
...
let summary = "Expandable F# compiler"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/fscx-projects"
...
Target "RunTests" (fun _ ->
    ...
    |> NUnit3 (fun p ->
        { p with
            ...
            ToolPath = "packages" </> "NUnit.ConsoleRunner.3.6.1" </> "tools" </> "nunit3-console.exe" })
)
...
let fakePath = "packages" </> "FAKE.4.61.3" </> "tools" </> "FAKE.exe"
